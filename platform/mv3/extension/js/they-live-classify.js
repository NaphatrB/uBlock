...
export const DOMAIN_RULES = [
    ...
    ['progressive', 'THIS IS YOUR GOD'], ['geico', 'THIS IS YOUR GOD'], ['allstate', 'THIS IS YOUR GOD'],
    ['statefarm', 'THIS IS YOUR GOD'], ['creditkarma', 'THIS IS YOUR GOD'], ['experian', 'THIS IS YOUR GOD'],
    ...
    ['etoro', 'THIS IS YOUR GOD'], ['kraken', 'THIS IS YOUR GOD'],
    ['moneysupermarket', 'THIS IS YOUR GOD'], ['comparethemarket', 'THIS IS YOUR GOD'],
    ['gocompare', 'THIS IS YOUR GOD'], ['confused.com', 'THIS IS YOUR GOD'],
    // Real estate / mortgage
    ['rightmove', 'THIS IS YOUR GOD'], ['zoopla', 'THIS IS YOUR GOD'],
    ['zillow', 'THIS IS YOUR GOD'], ['trulia', 'THIS IS YOUR GOD'],
    ['realtor', 'THIS IS YOUR GOD'], ['redfin', 'THIS IS YOUR GOD'],
    ['habito', 'THIS IS YOUR GOD'], ['trussle', 'THIS IS YOUR GOD'],
    // Travel
    ['booking', 'CONSUME'], ['expedia', 'CONSUME'], ['airbnb', 'CONSUME'],
    ['skyscanner', 'CONSUME'], ['kayak', 'CONSUME'], ['tripadvisor', 'CONSUME'],
    ['easyjet', 'CONSUME'], ['ryanair', 'CONSUME'], ['thomascook', 'CONSUME'],
    ['jet2', 'CONSUME'], ['lastminute', 'CONSUME'], ['agoda', 'CONSUME'],
    ['hotels.com', 'CONSUME'], ['vrbo', 'CONSUME'], ['hostelworld', 'CONSUME'],
    // Food delivery / meal kits
    ['deliveroo', 'CONSUME'], ['ubereats', 'CONSUME'], ['doordash', 'CONSUME'],
    ['grubhub', 'CONSUME'], ['justeat', 'CONSUME'], ['hellofresh', 'CONSUME'],
    ['gousto', 'CONSUME'], ['getir', 'CONSUME'], ['gorillas', 'CONSUME'],
    // Sleep / therapy / mental health
    ['betterhelp', 'SLEEP'], ['talkspace', 'SLEEP'], ['calm', 'SLEEP'],
    ['headspace', 'SLEEP'], ['woebot', 'SLEEP'], ['cerebral', 'SLEEP'],
    // Beauty / wellness / health
    ['noom', 'CONFORM'], ['hollandandbarrett', 'CONFORM'],
    ['sephora', 'CONFORM'], ['ulta', 'CONFORM'], ['glossier', 'CONFORM'],
    ['loccitane', 'CONFORM'], ['theordinary', 'CONFORM'],
    // News / media
    ...
    ['supercell', 'PLAY 8 HOURS'], ['plarium', 'PLAY 8 HOURS'], ['scopely', 'PLAY 8 HOURS'],
    ['zynga', 'PLAY 8 HOURS'], ['niantic', 'PLAY 8 HOURS'], ['activision', 'PLAY 8 HOURS'],
    ['wargaming', 'PLAY 8 HOURS'], ['garena', 'PLAY 8 HOURS'], ['kabam', 'PLAY 8 HOURS'],
    // Dating / reproduction
...
export const KEYWORD_RULES = [
    ...
    [/\bmortgage\b|\bproperty\b|\breal.?estate\b/i, 'THIS IS YOUR GOD'],
    ...
    [/\btherap(?:y|ist)\b|\bmental.?health\b|\bcounsel(?:l?ing|l?or)\b/i, 'SLEEP'],
    [/\bmeditat(?:e|ing|ion)\b/i, 'SLEEP'],
    [/\bsupplement\b|\bvitamin\b|\bweight.?loss\b|\bslimming\b/i, 'CONFORM'],
